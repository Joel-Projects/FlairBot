      ...
      return (
          <div>
            <div className={"form-group"} id={this.state.id}>
              ...
              <textarea id={this.state.nameLower + 'input'} defaultValue={this.state.defaultValue} placeholder={this.props.placeholder} onChange={(e) => {this.handleChange(e)}} ref={(input) => this.textInput = input} className={"form-control"}/>
            </div>
